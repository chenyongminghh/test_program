...
def main(args):
    ...
    if args.mluid:
        mlu_id = args.mluid.strip()
        result = 'PASS' if CAM.mt_run_power_Test_only_x8_filter(case_name, ipu_cmd, high_loops, low_loops, inner_loops, dvt_dir, dvt_name, mlu_id) else 'FAIL'
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mluid', action='store', choices=['0', '1'], help='High loops')
