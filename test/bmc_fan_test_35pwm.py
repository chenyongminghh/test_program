...
def fan_check(imm_num):
    ...
    amb['hilim']['fan0_inlet'] = 5800
    amb['hilim']['fan1_inlet'] = 5800
    amb['hilim']['fan2_inlet'] = 5800
    amb['hilim']['fan3_inlet'] = 5800
    amb['hilim']['fan4_1_inlet'] = 11550
    amb['hilim']['fan4_2_inlet'] = 11550
    
    amb['lolim']['fan0_inlet'] = 4800
    amb['lolim']['fan1_inlet'] = 4800
    amb['lolim']['fan2_inlet'] = 4800
    amb['lolim']['fan3_inlet'] = 4800
    amb['lolim']['fan4_1_inlet'] = 9450
    amb['lolim']['fan4_2_inlet'] = 9450
    
    amb['hilim']['fan0_outlet'] = 5800
    amb['hilim']['fan1_outlet'] = 5800
    amb['hilim']['fan2_outlet'] = 5800
    amb['hilim']['fan3_outlet'] = 5800
    amb['hilim']['fan4_1_outlet'] = 9372
    amb['hilim']['fan4_2_outlet'] = 9372
    
    amb['lolim']['fan0_outlet'] = 4800
    amb['lolim']['fan1_outlet'] = 4800
    amb['lolim']['fan2_outlet'] = 4800
    amb['lolim']['fan3_outlet'] = 4800
    amb['lolim']['fan4_1_outlet'] = 7668
    amb['lolim']['fan4_2_outlet'] = 7668
...
def main():
    case_name = 'BMC Fan Test at 35% PWM'
    ...
    for imm_num in range(imm_qty):
        imm.set_fan_speed_mfg(imm_num, speed='35')
        time.sleep(10)
