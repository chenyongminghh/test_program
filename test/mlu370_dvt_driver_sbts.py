...
def main(args):
    case_name = 'mlu370 DVT Driver SBTS Test'
    logging.info(case_name, section=True)
    
    test_list = ['mlu370_sbts_T_IPU_1V_DRV_01', 'mlu370_sbts_T_IPU_1V_DRV_02', 'mlu370_sbts_T_IPU_1V_DRV_03']
    logging.info('Running <{}> Driver-sbts test cases'.format(len(test_list)))
    
    test_loops = args.loops.strip() if args.loops else '1'
    logging.info('Running DVT Driver-sbts Test <{}> loops'.format(test_loops))
