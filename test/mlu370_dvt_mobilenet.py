...
def main(args):
    case_name = 'mlu370 DVT Mobilnet Test'
    ...
    if board_type in ['EVBD', 'X4', 'M8', 'X4K', 'X4L']:
        test_list = ['mlu370_handng_mobilenet_8u1']
    elif board_type in ['S4', 'S8', 'X9', 'X9L']:
        test_list = ['mlu370_handng_mobilenet_6u1']
    elif board_type == 'X8':
        test_list = ['mlu370_handng_mobilenet_4u1']
    elif board_type == 'D2':
        test_list = ['mlu370_handng_mobilenet_2u1']
    else:
        test_list = ['mlu370_handng_mobilenet_4u1']
