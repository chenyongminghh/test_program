...
def ipu_frequency_read(mcPort, mcSN, caseName, debug_tool):
    ...
    if die0_freq != '1000MHz' or die1_freq != '1000MHz':
        logging.info('{} Failed on Card{} [{} sec] -- Die0:{} Die1:{}'.format(caseName, mcPort, total_seconds, die0_freq, die1_freq))
        return False
    logging.info('{} Passed on Card{} [{} sec] -- Die0:{} Die1:{}'.format(caseName, mcPort, total_seconds, die0_freq, die1_freq))
    return True
    
def main(args):
    case_name = 'mlu370 IPU Frequency Check'
