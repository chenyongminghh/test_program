...
def main(args):
    case_name = 'mlu370 DVT Driver NVME Test'
    ...
    test_list = ['mlu370_spider_SPIDER_NVME_TEST']
    logging.info('Running DVT Spider-NVME <{}> test cases'.format(len(test_list)))
    
    test_loops = args.loops.strip() if args.loops else '1'
    logging.info('Running DVT Spider-NVME Test <{}> loops'.format(test_loops))
