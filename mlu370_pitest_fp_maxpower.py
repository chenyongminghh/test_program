...
def main(args):
    case_name = 'mlu370 PITest FP Maxpower Test'
    ...
    low_loops = args.low.strip() if args.low else '0'
    inner_loops = args.inner.strip() if args.inner else '0'
    dimz_loops = args.dimz.strip() if args.dimz else '100000'
    
    cmd_dict = dict()
    cmd_dict['S4'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U6'
    cmd_dict['S8'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U6'
    cmd_dict['X9'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U6'
    cmd_dict['X9L'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U6'
    cmd_dict['X4'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U8'
    cmd_dict['X8'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U4'
    cmd_dict['EVBD'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U8'
    cmd_dict['M8'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U8'
    cmd_dict['D2'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U2'
    cmd_dict['X4K'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U8'
    cmd_dict['X4L'] = 'mlu370_ipu_IPU_INST_FP_MAXPOWER_U8'
    
    dvt_dir = 'dvt-power'
    dvt_name = 'fp_maxpower'
    ipu_cmd = cmd_dict[board_type]
    CAM.mlu370_dimz('fp_test', 'maxp_u1', dimz_loops)
    CAM.mlu370_dimz('fp_test', 'maxp_u4', dimz_loops)
    CAM.mlu370_dimz('fp_test', 'maxp_u8', dimz_loops)
